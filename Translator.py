...
def create_always_on_top_window():
    ...
    button = tk.Button(window, text="Call Function", command=reverse_translate_text)
    button.pack()
root = tk.Tk()
...
translation_text = scrolledtext.ScrolledText(root, state="disabled", wrap="word")
translation_text.pack(fill=tk.BOTH, expand=True)
original_text = scrolledtext.ScrolledText(root, state="disabled", wrap="word")
